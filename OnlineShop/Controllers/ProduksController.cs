...
namespace OnlineShop.Controllers
{
    public class ProduksController : Controller
    {
        ...
        public ProduksController(OnlineShopContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdProduk,Nama,Harga,Deskripsi")] Produk produk)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProduk,Nama,Harga,Deskripsi")] Produk produk)
        {
