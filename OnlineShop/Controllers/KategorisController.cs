...
namespace OnlineShop.Controllers
{
    public class KategorisController : Controller
    {
        ...
        public KategorisController(OnlineShopContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdKategori,Nama")] Kategori kategori)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdKategori,Nama")] Kategori kategori)
        {
